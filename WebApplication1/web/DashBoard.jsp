<%-- 
    Document   : DashBoard
    Created on : 25 mar. 2023, 17:32:40
    Author     : Marco A Aguirre G
-------------MOD--------------------

    Modified on : 13 mar. 2023
    Author     : Gabriela Sarai Villalon Martinez
                                    ...
                                    <div class="container-md align-items-center" >
                                        ...
                                        <div class="col-sm-2" >
                                             <form action="perfil.html" method="get">
                                                    ...
                                                    <button class="btn">
                                                        <img src="imagenes/linkicon.png" class="round_img" c lass="a_center" alt="Profile Picture" width="72" height="72">
                                                    </button>
                                                </form>
                                        </div>
                            ...
                            <div class="container-card">
                                <div class="card mb-4 box-shadow">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <img src="imagenes/kid.png" alt="Thumbnail" class="center">
                                ...
                                <div class="card mb-4 box-shadow">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-2">
                                                <form action="perfil-ajeno.html" method="get">
                                                    <button class="btn">
                                                        <img src="imagenes/Thisisnotlinkicon.png" class="round_img" c lass="a_center" alt="Profile Picture" width="72" height="72">
                                                    </button>
                                                </form>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <p class="card-text">Las papas firtas se comen con mayonesa y no pueden cambiar mi opinion.</p>
