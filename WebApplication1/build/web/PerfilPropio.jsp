<%-- 
    Document   : PerfilPropio
    Created on : 25 mar. 2023, 17:41:49
        ...
        <div class="col-md-8">
            ...
            <div class="row">
                ...
                <div class="jumbotron p-3 p-md-5 text-white rounded ">
                    ...
                    <div class="row">
                        <div style="">
                            <img src="imagenes/linkicon.png" class="round_img" alt="Profile Picture" width="200" height="200">
                        </div>
                        <div>
                        ...
                        <div class="container-card">
                            ...
                            <div class="card mb-4 box-shadow">
                                ...
                                <div class="container-md align-items-center">
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <form action="PerfilPropio.jsp" method="get">
                            ...
                            <div class="card mb-4 box-shadow">
                                ...
                                <div class="container-md align-items-center">
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <form action="PerfilPropio.jps" method="get">
